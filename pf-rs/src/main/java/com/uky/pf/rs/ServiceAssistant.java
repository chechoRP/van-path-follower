...
@References(value={
    @Reference(name="PathFollowerService", 
               referenceInterface=com.uky.pf.api.PathFollowerService.class,
...
public class ServiceAssistant {
    ...
    /**
     * Hook for registering PathFollowerService implementation via declarative services.
     *
     * @param s newly advertised service to register
     * @param properties the properties associated with the service
     */
    protected void bindPathFollowerService(com.uky.pf.api.PathFollowerService s, Map<String, Object> properties) {
        sl.register(com.uky.pf.api.PathFollowerService.class, s, properties);
    }
     ...
     */
    protected void unbindPathFollowerService(com.uky.pf.api.PathFollowerService s) {
        sl.unregister(com.uky.pf.api.PathFollowerService.class, s);
    }
